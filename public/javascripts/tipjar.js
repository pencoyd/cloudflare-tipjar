CloudFlare.define("tipjar",
  ...
  function(config, $) {
    ...
    window.CF_TIPJAR['ELEMENTS'] = {
      ...
      'endsection': tipjar_frame.find('#endsection')
    }
    ...
    var congratulations = function() {
      window.CF_TIPJAR['ELEMENTS']['copy_heading'].html("You're a good human.");
      window.CF_TIPJAR['ELEMENTS']['copy_body'].html("");
      window.CF_TIPJAR['ELEMENTS']['midsection'].html("You tipped the author $" + window.CF_TIPJAR['TIP']);
      window.CF_TIPJAR['ELEMENTS']['endsection'].html('<a class="button" onclick="hideTipjar();">Close</a>');
    }
    ...
    var sendPayment = function() {
      ...
      $.post(
        ...
        function(data) {
          ...
          window.CF_TIPJAR['ELEMENTS']['midsection'].html("Please try again.");
        }
      );
    ...
    var loadHTML = function() {
      $('<div id="tipjar_frame"><a id="hide_tipjar_frame_btn">&times;</a><div id="copy"><p id="copy_heading">Did you enjoy this content?</p><p id="copy_body">This is free content, and the author lives on tips, so don&#39;t be afraid to tip!</p></div><div id="midsection"><form id="tipjar_form"><a id="dollarsign">$</a><input id="cf_tipjar_amount" name="cf_tipjar_amount" value="1.00" type="number" min="0.01" step="0.01"><a id="cf_tipjar_start" class="button">Give!</a></form></div><div id="endsection">No thanks, I don&#39;t want to donate to the author.</div></div><div id="tipjar"><img id="show_tipjar_button" src="http://ajax.cloudflare.com/cdn-cgi/nexp/apps/tipjar/images/tipjar.png"/><a id="hide_tipjar_btn">&times;</a></div>').appendTo('body');
    }
