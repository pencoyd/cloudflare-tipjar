CloudFlare.define("tipjar",
  ...
  function(config, $) {
    ...
    var congratulations = function() {
      ...
      window.CF_TIPJAR['ELEMENTS']['endsection'].html('<a class="button" href="#" id="cf_tipjar_close_btn">Close</a>');
    }
